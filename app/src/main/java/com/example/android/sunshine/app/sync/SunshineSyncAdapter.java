...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, DataApi.DataListener, MessageApi.MessageListener {
    ...
    private ContentValues valuesToSend;
    ...
    public void onConnected(Bundle bundle) {
        ...
        putDataMapRequest.getDataMap().putInt("max", valuesToSend.getAsInteger(WeatherContract.WeatherEntry.COLUMN_MAX_TEMP));
        putDataMapRequest.getDataMap().putInt("min", valuesToSend.getAsInteger(WeatherContract.WeatherEntry.COLUMN_MIN_TEMP));
        putDataMapRequest.getDataMap().putString("weather_id", valuesToSend.getAsString(WeatherContract.WeatherEntry.COLUMN_WEATHER_ID));
        ...
        for(DataEvent dataevent : dataEvents){
            if(dataevent.getType() == DataEvent.TYPE_CHANGED){
                ...
                if(path.equals("/sunshine")){
                    ...
                    String weather_id = dataMap.getString("weather_id");
                    Log.e("Data item handled", weather_id+" - min: "+min+" - max:"+max);
                }
            }
        }
    ...
    public void onMessageReceived(MessageEvent messageEvent) {
        Log.e("He recibido cosas kio", messageEvent.getData().toString()+"");
    }
    ...
    private void updateWidgets() {
        ...
        Log.e("Image used", valuesToSend.getAsString(WeatherContract.WeatherEntry.COLUMN_WEATHER_ID) + "");
